...
Genesis is a public edition of a Big Bang tag. You install the charts in this repository. These pages are the operator guide.

| | |
|---|---|
| [Install](install.md) | Flux, the umbrella, and how you know it is up |
| [This edition](edition.md) | What a Genesis tag contains |
...
The newest snapshot is `main`. A numbered tag such as `3.33.0` is that Big Bang version.
