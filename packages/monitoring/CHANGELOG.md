...
---
## [87.10.1-bb.3] (2026-07-27)
### Added
- Added new prometheus rule to detect connection failures in ambient
- Updated IstioAmbientReadinessProbeFailures to be cricital severity

## [87.10.1-bb.2] (2026-07-17)
### Added
- Keycloak SSO login handling in the cypress health and targets specs for authservice-protected routes

### Changed
- bb-common 1.0.2 -> 1.2.0
- Corrected the prometheus route selector to use the canonical `app.kubernetes.io/name: prometheus` label

## [87.10.1-bb.1] (2026-07-16)
### Changed
- Moved `prometheusRule` key out of `istio` key
- Fixed bug in Istio 5XX rule
- Added alert for Istio-CNI/Ambient specific workloads

## [87.10.1-bb.0] (2026-07-07)
### Changed
- bb-common 0.15.0 -> 1.0.2
- gluon 1.1.0 -> 1.1.2
- kube-prometheus-stack 85.3.3 -> 87.10.1
- prometheus-blackbox-exporter 11.10.0 -> 11.15.1
- prometheus-snmp-exporter 9.14.0 -> 9.16.1
- registry1.dso.mil/ironbank/kiwigrid/k8s-sidecar 2.7.3 -> 2.8.1
- registry1.dso.mil/ironbank/opensource/kubernetes/kube-state-metrics v2.19.0 -> v2.19.1
- registry1.dso.mil/ironbank/opensource/kubernetes/kubectl v1.35.5 -> v1.35.6
- registry1.dso.mil/ironbank/opensource/bats/bats v1.11.0 -> 1.13.0
- registry1.dso.mil/ironbank/opensource/prometheus-operator/prometheus-config-reloader v0.91.0 -> v0.92.1
- registry1.dso.mil/ironbank/opensource/prometheus-operator/prometheus-operator v0.91.0 -> v0.92.1
- registry1.dso.mil/ironbank/opensource/prometheus/alertmanager v0.32.1 -> v0.33.1
- registry1.dso.mil/ironbank/opensource/prometheus/prometheus v3.11.3 -> v3.13.0
- Removed the deprecated `bigbang.dev/applicationVersions` annotation and corrected image metadata coverage.

## [85.3.3-bb.2] (2026-07-02)
### Changed
- Updated the metrics-upgrade-job to use BB-Common egress NetworkPolicy configuration for Kubernetes API access and removed the custom metrics-upgrade-job NetworkPolicy resource.

## [85.3.3-bb.1] (2026-06-25)
### Changed
- Removed Sidecar-Only logic from webhookException PeerAuthentication
...
## [83.4.0-bb.2] (2026-04-30)
### Changed
- Changed the default for `istio.authorizationPolicies.enabled` to true to match grafana default
