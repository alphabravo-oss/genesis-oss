...
- registry1.dso.mil/ironbank/grafana/grafana-enterprise-logs v3.5.4 -> v3.6.5
- registry1.dso.mil/ironbank/ironbank/opensource/grafana/enterprise-logs-provisioner 3.5.4 -> 3.6.5
- registry1.dso.mil/ironbank/opensource/kubernetes/kubectl v1.33.6 -> v1.34.6
- registry1.dso.mil/ironbank/bigbang/grafana/loki-canary 3.5.5 -> 3.7.1
- registry1.dso.mil/ironbank/opensource/memcached/memcached 1.6.39 -> 1.6.41
- registry1.dso.mil/ironbank/kiwigrid/k8s-sidecar 1.30.9 -> 2.5.0

## [6.55.0-bb.1] (2026-04-27)

### Fixed

- Fixed `loki.thanosStorageConfig` helper rendering null S3 credential fields (`access_key_id`, `secret_access_key`, `endpoint`, `region`) into the rendered config when using the Thanos object store path; replaced raw `toYaml` with explicit `with` guards to suppress unset keys
- Fixed `loki.lokiStorageConfig.s3` helper unconditionally forcing `s3forcepathstyle: false` into the rendered config; field is now only emitted when explicitly set by the operator

### Updated
- registry1.dso.mil/ironbank/opensource/nginx/nginx 1.29.7 -> 1.30.0

## [6.55.0-bb.0] (2026-03-28)

### Changed
- bb-common 0.12.2 -> 0.14.1
- gluon 0.9.7 -> 0.9.8
- grafana-agent-operator 0.5.1 -> 0.5.2
- loki 6.46.0 -> 6.55.0
- registry1.dso.mil/ironbank/bigbang/grafana/loki-canary 3.5.5 -> 3.7.1
- registry1.dso.mil/ironbank/grafana/grafana-enterprise-logs v3.5.4 -> v3.6.5
- registry1.dso.mil/ironbank/ironbank/opensource/grafana/enterprise-logs-provisioner 3.5.4 -> 3.6.5
- registry1.dso.mil/ironbank/kiwigrid/k8s-sidecar 1.30.9 -> 2.5.0
- registry1.dso.mil/ironbank/opensource/grafana/loki 3.5.7 -> 3.7.1
- registry1.dso.mil/ironbank/opensource/grafana/loki 3.5.5 -> 3.7.1
- registry1.dso.mil/ironbank/opensource/kubernetes/kubectl v1.33.6 -> v1.34.6
- registry1.dso.mil/ironbank/opensource/memcached/memcached 1.6.39 -> 1.6.41
- registry1.dso.mil/ironbank/opensource/nginx/nginx 1.29.3 -> 1.29.7
- rollout-operator 0.33.2 -> 0.46.0
