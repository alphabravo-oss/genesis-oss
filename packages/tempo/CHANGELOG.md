...
## [2.1.0-bb.0] (2026-05-02)
### Changed
- bb-common 0.14.1 -> 0.15.0
- gluon 0.9.8 -> 1.0.1
- registry1.dso.mil/ironbank/opensource/grafana/tempo 2.10.1 -> 2.10.5
- registry1.dso.mil/ironbank/opensource/grafana/tempo-query 2.10.1 -> 2.10.5
...
- Updated Gluon from 0.9.2 to 0.9.7
- Removed legacy values and configuration settings related to Tempo's UI functionality

## [1.23.3-bb.0] (2025-10-09)
### Updated
- Update tempo chart tag from 1.21.1 to 1.23.3
- Changed tempo port from `3100` to `3200`
- Removed the podAnnotation/traffic.sidecar.istio.io/includeInboundPorts
...
## [1.21.0-bb.0] (2025-04-16)
### Changed
- tempo 1.20.0 -> 1.21.0

## [1.20.0-bb.0] - 2025-04-10
### Updated

- Updated tempo chart: `1.19.0` -> `1.20.0`
- Updated tempo: `2.7.1` -> `2.7.2`
- Updated tempo-query `2.7.1` -> `2.7.2`
