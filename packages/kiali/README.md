...
![Version: 2.30.0-bb.0](https://img.shields.io/badge/Version-2.30.0--bb.0-informational?style=flat-square) ![AppVersion: 2.30.0](https://img.shields.io/badge/AppVersion-2.30.0-informational?style=flat-square) ![Maintenance Track: bb_integrated](https://img.shields.io/badge/Maintenance_Track-bb_integrated-green?style=flat-square)
...
| waitJob.image | string | `"registry1.dso.mil/ironbank/opensource/kubernetes/kubectl:v1.35.7"` |  |
...
| upstream.image.tag | string | `"v2.30.0"` |  |
...
| upstream.cr.spec.deployment.image_version | string | `"v2.30.0"` |  |
