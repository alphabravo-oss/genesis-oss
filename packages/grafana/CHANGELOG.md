...
- Migrated the upstream Grafana chart source to `grafana-community/helm-charts`
- Replaced the legacy Istio hardening guide with Grafana-specific `bb-common` integration documentation
- bb-common updated from 0.14.2 -> 1.0.2
- gluon updated from 0.9.8 -> 1.1.1
- registry1.dso.mil/ironbank/big-bang/grafana/grafana-plugins updated from 12.4.2 -> 13.0.1
- registry1.dso.mil/ironbank/kiwigrid/k8s-sidecar updated from 2.5.4 -> 2.8.1
- registry1.dso.mil/ironbank/opensource/grafana/grafana-image-renderer updated from v5.7.3 -> v5.9.0
- registry1.dso.mil/ironbank/redhat/ubi/ubi9-minimal updated from 9.7 -> 9.8
- Disabled Grafana's first-session splash screen
