# 3.28.0 compared with 3.33.0

Enabled packages: 15.

- istioCRDs 1.30.2-bb.0 (3.33.0 is 1.30.4-bb.0).
- istiod 1.30.2-bb.0 (3.33.0 is 1.30.4-bb.0).
- istioGateway 1.30.2-bb.0 (3.33.0 is 1.30.4-bb.0).
- kiali 2.28.0-bb.0 (3.33.0 is 2.31.0-bb.0).
- kyverno 3.8.1-bb.4 (3.33.0 is 3.9.1-bb.0).
- kyvernoPolicies 3.3.4-bb.65 (3.33.0 is 3.3.4-bb.87).
- kyvernoReporter 3.7.4-bb.3 (3.33.0 is 3.10.0-bb.2).
- alloy 4.1.7-bb.0 (3.33.0 is 4.3.2-bb.0).
- loki 6.55.0-bb.2 (3.33.0 is 6.55.0-bb.7).
- neuvector 2.10.3-bb.0 (3.33.0 is 2.11.1-bb.0).
- tempo 2.1.0-bb.1 (3.33.0 is 2.1.0-bb.2).
- prometheusOperatorCRDs 28.0.1-bb.0 (3.33.0 is 31.0.1-bb.0).
- monitoring 85.3.3-bb.2 (3.33.0 is 88.6.2-bb.0).
- grafana 10.5.15-bb.3 (3.33.0 is 12.10.0-bb.0).
...
- gap: neuvector registry1.dso.mil/ironbank/opensource/neuvector/registry-adapter:v0.2.7 (no public repo in the 3.33.0 map)
- gap: tempo registry1.dso.mil/ironbank/opensource/grafana/tempo-query:2.10.5 (no public repo in the 3.33.0 map)
- gap: monitoring registry1.dso.mil/ironbank/opensource/bats/bats:v1.11.0 (no public repo in the 3.33.0 map)
...
- gap: grafana registry1.dso.mil/ironbank/redhat/ubi/ubi9-minimal:9.7 (no public repo in the 3.33.0 map)
- gap: grafana registry1.dso.mil/ironbank/opensource/grafana/grafana-image-renderer:v5.7.3 (no public repo in the 3.33.0 map)
